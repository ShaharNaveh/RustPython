...
OUT_FILE = CRATE_DIR / "src" / f"{sys.platform}.rs"
...
pub(crate) const DATA: [(&str, Option<&str>); {size}] = [{lines}];
""".lstrip()

    OUT_FILE.write_text(out)
    subprocess.run(["cargo", "fmt"], cwd=CRATE_DIR)
