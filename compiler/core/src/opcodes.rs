...
impl RealOpcode {
    pub const fn deopt(&self) -> Option<Self> {
        Some(match *self {
            ...
            | Self::BinaryOpSubtractInt => Self::BinaryOp,
...
impl TryFrom<i16> for PseudoOpcode {
    type Error = ();
...
impl TryFrom<i32> for PseudoOpcode {
    type Error = ();
...
impl TryFrom<i64> for PseudoOpcode {
    type Error = ();
...
impl TryFrom<i128> for PseudoOpcode {
    type Error = ();
...
impl TryFrom<isize> for PseudoOpcode {
    type Error = ();
...
impl TryFrom<u8> for PseudoOpcode {
    type Error = ();
...
impl TryFrom<u32> for PseudoOpcode {
    type Error = ();
...
impl TryFrom<u64> for PseudoOpcode {
    type Error = ();
...
impl TryFrom<u128> for PseudoOpcode {
    type Error = ();
...
impl TryFrom<usize> for PseudoOpcode {
    type Error = ();
