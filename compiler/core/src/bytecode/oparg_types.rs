...
impl CompareOparg {
    #[must_use]
    pub fn cmp_op(self) -> Result<CmpOp, crate::MarshalError> {
        CmpOp::try_from(self)
    }
...
impl crate::AnyOparg for BinOpOparg {}

impl TryFrom<u32> for BinOpOparg {
    type Error = crate::MarshalError;
...
impl crate::AnyOparg for BuildSliceOparg {}

impl TryFrom<u32> for BuildSliceOparg {
    type Error = crate::MarshalError;
...
impl crate::AnyOparg for CallIntrinsic1Oparg {}

impl TryFrom<u32> for CallIntrinsic1Oparg {
    type Error = crate::MarshalError;
...
impl crate::AnyOparg for CallIntrinsic2Oparg {}

impl TryFrom<u32> for CallIntrinsic2Oparg {
    type Error = crate::MarshalError;
...
impl TryFrom<CompareOparg> for CmpOp {
    ...
    fn try_from(value: CompareOparg) -> Result<Self, Self::Error> {
        Self::try_from(u32::from(value) >> 5)
    }
}

impl TryFrom<u32> for CmpOp {
    type Error = crate::MarshalError;
...
impl crate::AnyOparg for ConvertValueOparg {}

impl TryFrom<u32> for ConvertValueOparg {
    type Error = crate::MarshalError;
...
impl crate::AnyOparg for InvertOparg {}

impl TryFrom<u32> for InvertOparg {
    type Error = crate::MarshalError;
...
impl crate::AnyOparg for RaiseVarargsOparg {}

impl TryFrom<u32> for RaiseVarargsOparg {
    type Error = crate::MarshalError;
...
impl crate::AnyOparg for ResumeOparg {}

impl TryFrom<u32> for ResumeOparg {
    type Error = crate::MarshalError;
...
impl crate::AnyOparg for SetFunctionAttributeOparg {}

impl TryFrom<u32> for SetFunctionAttributeOparg {
    type Error = crate::MarshalError;
...
impl crate::AnyOparg for WhereOparg {}

impl TryFrom<u32> for WhereOparg {
    type Error = crate::MarshalError;
