...
# NOTE(RUSTPYTHON): We are marking the following tests in this way because they are created by a factory method at runtime that will override our normal patching method
TestUnstructuredHeader.test_value_rfc2047_gb2312_base64 = unittest.expectedFailure(TestUnstructuredHeader.test_value_rfc2047_gb2312_base64) # TODO: RUSTPYTHON
