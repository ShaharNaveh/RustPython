...
class ProgramsTestCase(BaseTestCase):
    ...
    @unittest.expectedFailure # TODO: RUSTPYTHON; AttributeError: module 'faulthandler' has no attribute 'dump_traceback_later'
...
class ArgsTestCase(BaseTestCase):
    ...
    @unittest.expectedFailure # TODO: RUSTPYTHON; ImportError: cannot import name 'raise_signal'
