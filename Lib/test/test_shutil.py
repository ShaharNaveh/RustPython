...
class TestRmTree(BaseTest, unittest.TestCase):
    ...
    @unittest.expectedFailureIfWindows('TODO: RUSTPYTHON; AssertionError: OSError not raised by rmtree')
...
class TestCopy(BaseTest, unittest.TestCase):
    ...
    @unittest.expectedFailureIfWindows('TODO: RUSTPYTHON; AssertionError: 33060 != 33206')
